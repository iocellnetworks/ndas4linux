linuxum-dev:
	...
	make EXPORT_LOCAL=y nxpo-debug=y nxpo-sio=y nxpo-asy=y nxpo-hix=y nxpo-embedded=n nxpo-bpc=y nxpo-persist=y nxpo-automated=y nxpo-pnp=y nxpo-emu=y nxpo-raid=n all

linuxum-rel:
	make EXPORT_LOCAL=y nxp-cpu=arm nxpo-sio=y nxpo-pnp=y nxpo-asy=y nxpo-hix=y nxpo-debug=n nxpo-embedded=n nxpo-bpc=y nxpo-persist=y nxpo-automated=y nxpo-probe=y all
