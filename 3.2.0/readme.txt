# -----------------------------------------------------------------------------
# Copyright (c) 2012 IOCELL Networks Corp., Plainsboro NJ 08536, USA
# All rights reserved.
# -----------------------------------------------------------------------------
 ...
 * Version Pakages for widely used operating systems such as linux-x86.
   ...
   - License: IOCELL Networks Copyright / GPL
   - Distribution: Compiled products and source code may only be made avaialble
     by IOCELL Networks Corp. Please submit all changes or local versions for 
     for review before adding to the public repository. Other distribution or
