...
*/
/*
** NAME:    $Source: /home/ps2cvs/ps2sdk/ee/libc/src/xprintf.c,v $
** VERSION: $Revision: 1.3 $
** DATE:    $Date: 2004-07-22 14:06:39 -0700 (Thu, 22 Jul 2004) $
**
...
{
    return vsnprintf(str, XPRINTF_STR_MAX, format, args);
}
#endif
...
int puts(const char *str)
{
    ...
    printf(str); /* fioWrite(1, (void *)str, len); 
    putchar('\n'); */
    return len + 1;
}
#endif
...
{
    static char buf[XPRINTF_STR_MAX];
    va_list args;
    int ret;

    va_start(args, format);
    ret = vsnprintf(buf, XPRINTF_STR_MAX, format, args);
    va_end(args);
