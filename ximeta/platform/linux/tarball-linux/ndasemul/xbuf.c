...
sal_net_buff sal_net_copy_platform_buf(sal_net_buff buf, xuint32 neth_len, xuint32 data_len, sal_net_buf_seg* bufs) {
...
struct xbuf* _xbuf_create(int size)
{
    char* buf;
    struct xbuf* xb;
    int alloc_size;
...
void _xbuf_destroy(struct xbuf* xb)
{
