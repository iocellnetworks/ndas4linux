...
EXPORT_SYMBOL(sal_create_mem_pool);
...
EXPORT_SYMBOL(sal_destroy_mem_pool);
...
EXPORT_SYMBOL(sal_alloc_page_array);
...
EXPORT_SYMBOL(sal_get_pages_from_virtual);
