/*
 -------------------------------------------------------------------------
 Copyright (c) 2005, XIMETA, Inc., FREMONT, CA, USA.
 All rights reserved.
 ...
 * headenc : true if the header infomation should be encrypted
 ...
 * The infomation is obtained when the device can be connected. 
