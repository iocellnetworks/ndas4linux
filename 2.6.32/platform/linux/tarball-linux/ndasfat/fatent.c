...
static inline void lock_fat(struct ndasfat_sb_info *sbi)
{
	mutex_lock(&sbi->fat_lock);
}

static inline void unlock_fat(struct ndasfat_sb_info *sbi)
{
...
static inline int fat_ent_next(struct ndasfat_sb_info *sbi,
			       struct fat_entry *fatent)
{
