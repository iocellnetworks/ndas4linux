...
extern int ndas_scsi_exit(void);
...
int ndas_scsi_module_init(void) 
{    
    int ret;
...
void ndas_scsi_module_exit(void) 
{
    ndas_scsi_exit();
...
module_init(ndas_scsi_module_init);
module_exit(ndas_scsi_module_exit);
