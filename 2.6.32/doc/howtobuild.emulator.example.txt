...
0. Overview
   ...
   And if you need changes in NDAS library or have feature request, please contact XIMETA, Inc.
 ...
 * Note that if you have only one registered device at a time, its slot number always is 1. In other cases, consult /proc/ndas/devices/<Device Name>/slots for exact slot number. 
  * See http://code.ximeta.com/cgi-bin/trac.cgi/wiki/Usage for detailed usages. 
 ...
 * Visit http://code.ximeta.com for overall information about NDAS driver.(Emulator is not covered yet).
