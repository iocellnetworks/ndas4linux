...
typedef xbool        (*XlibHashMatchFunc)(void* key, void* value, void* user_data);
...
extern xbool xlib_hash_table_remove(XLIB_HASH_TABLE* table, const void* key);
extern void xlib_hash_table_foreach(XLIB_HASH_TABLE* table, XlibHashIteFunc func, void* user_data);
extern xuint32 xlib_hash_table_foreach_remove(XLIB_HASH_TABLE* table, XlibHashMatchFunc func, void* user_data);
extern xuint32 xlib_hash_table_size(XLIB_HASH_TABLE* table);
